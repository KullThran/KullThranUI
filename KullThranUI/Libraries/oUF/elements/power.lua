...
local function GetDisplayPower(_, unit)
	...
	local grouped = (not (issecretvalue and issecretvalue(inParty)) and inParty == true)
		or (not (issecretvalue and issecretvalue(inRaid)) and inRaid == true)
	if(barInfo and barInfo.showOnRaid and grouped) then
...
local function UpdateColor(self, event, unit)
	...
	elseif(element.colorClass and (UnitIsPlayer(unit) or UnitInPartyIsAI(unit)))
		...
		if _G.KullThranUI and _G.KullThranUI.SafeUnitClass then
			_, class = _G.KullThranUI.SafeUnitClass(unit)
		else
