...
local function Update(self, event, unit)
	...
	* unit - the unit for which the update has been triggered (string)
	...
	local ffaReadable = not (issecretvalue and issecretvalue(isFFA))
	local pvpReadable = not (issecretvalue and issecretvalue(isPVP))
	if(ffaReadable and isFFA == true) then
		status = 'FFA'
	elseif(pvpReadable and factionGroup ~= 'Neutral' and isPVP == true) then
