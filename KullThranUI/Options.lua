...
local CHANGELOG_LATEST_ARCHIVED_VERSION = "5.0.9"
...
local CHANGELOG_ENTRIES = {
    ["5.0.9"] = {
        ...
        sourceLabel = "GitHub",
        sourceUrl = "https://github.com/KullThran/KullThranUI/releases/tag/v5.0.9",
        notes = {
...
local function UpdateMenuThemeVisuals(menu)
	...
	menu._versionText:SetText(string.format("|cff%02x%02x%02xv%s|r", vr, vg, vb, menu._versionValue or (KT.VERSION or "5.0.9")))
    end
