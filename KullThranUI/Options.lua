...
local CHANGELOG_LATEST_ARCHIVED_VERSION = "5.0.5"
...
local CHANGELOG_ENTRIES = {
    ["5.0.5"] = {
        ...
        notes = {
            ...
            "Added per-module profile import and export controls to options ns.pages and corrected profile ownership for Action Bars, Bags, Progress Bars, External Addons, Enhancements, and other scoped settings.",
    ...
    ["5.0.2"] = {
        ...
        notes = {
            ...
            "Improved the in-game changelog window so its complete “Don’t show again” row is clickable, the current patch suppression state is restored correctly, and enabling or disabling the option is saved immediately.",
            ...
            "Reduced Cooldown Manager background work by replacing continuous glow polling with coalesced event-driven updates, refreshing only affected bars when possible, and avoiding redundant transition passes once Blizzard’s Cooldown Viewer pools have stabilized.",
    ...
    ["5.0.0"] = {
        ...
        notes = {
            ...
            "Added category overview ns.pages that present every available module as a large shortcut card with its icon and a concise description, while keeping the most recently selected category open in the right-hand panel.",
            "Corrected category selection and navigation feedback so only the active category remains highlighted, module counts appear only on category overview ns.pages, and expanded categories can coexist without changing the active page.",
            ...
            "Added and reviewed localization for the new 5.0.0 category ns.pages, Objective Tracker background controls, Armory PvP item-level settings, and related interface text across every supported language.",
...
local function UpdateMenuThemeVisuals(menu)
	...
	menu._versionText:SetText(string.format("|cff%02x%02x%02xv%s|r", vr, vg, vb, menu._versionValue or (KT.VERSION or "5.0.6")))
    end
