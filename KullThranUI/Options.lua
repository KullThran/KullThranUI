...
local CHANGELOG_LATEST_ARCHIVED_VERSION = "5.0.8"
...
local function UpdateMenuThemeVisuals(menu)
	...
	menu._versionText:SetText(string.format("|cff%02x%02x%02xv%s|r", vr, vg, vb, menu._versionValue or (KT.VERSION or "5.0.8")))
    end
