...
KUIMoveAPI:RegisterFrames({
    ...
    {
        MinVersion = 11505,
        -- Retail 12.0 protects mouse-button passthrough while MapCanvas pins
        -- are acquired. Making WorldMapFrame (and its QuestMapFrame children)
        -- movable taints that path and blocks Button:SetPassThroughButtons().
        MaxVersion = 120000,
        SilenceCompatabilityWarnings = true,
...
KUIMoveAPI:RegisterAddOnFrames({
    ...
    -- Leave Blizzard_UIWidgets completely untouched. These frames and related
    -- tooltip/widget paths are especially prone to taint in world content and combat.
