...
function MS:CreateLocation()
    ...
    MS:ApplyDetachedMinimapLayout(LocationFrame, DB.Layout)
    LocationFrame:SetFrameStrata(GeneralDB.FrameStrata)
    LocationFrame.Text = LocationFrame:CreateFontString(nil, "OVERLAY")
    LocationFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
...
function MS:UpdateLocation()
    ...
    if MS.LocationFrame then
        ...
        MS:ApplyDetachedMinimapLayout(MS.LocationFrame, DB.Layout)
        MS.LocationFrame:SetFrameStrata(GeneralDB.FrameStrata)
        MS.LocationFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
