...
function MS:CreateCoordinates()
    ...
    MS:ApplyDetachedMinimapLayout(CoordinatesFrame, DB.Layout)
    CoordinatesFrame:SetFrameStrata(GeneralDB.FrameStrata)
    CoordinatesFrame.Text = CoordinatesFrame:CreateFontString(nil, "OVERLAY")
    CoordinatesFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
...
function MS:UpdateCoordinates()
    ...
    if MS.CoordinatesFrame then
        ...
        MS:ApplyDetachedMinimapLayout(MS.CoordinatesFrame, DB.Layout)
        MS.CoordinatesFrame:SetFrameStrata(GeneralDB.FrameStrata)
        MS.CoordinatesFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
