...
function MS:CreateTime()
    ...
    MS:ApplyDetachedMinimapLayout(TimeFrame, DB.Layout)
    TimeFrame:SetFrameStrata(GeneralDB.FrameStrata)
    TimeFrame.Text = TimeFrame:CreateFontString(nil, "OVERLAY")
    TimeFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
...
function MS:UpdateTime()
    ...
    if MS.TimeFrame then
        ...
        MS:ApplyDetachedMinimapLayout(MS.TimeFrame, DB.Layout)
        MS.TimeFrame:SetFrameStrata(GeneralDB.FrameStrata)
        MS.TimeFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
