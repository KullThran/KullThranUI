...
function MS:CreateSystemStats()
    ...
    MS:ApplyDetachedMinimapLayout(SystemStatsFrame, DB.Layout)
    SystemStatsFrame:SetFrameStrata(GeneralDB.FrameStrata)
    SystemStatsFrame.Text = SystemStatsFrame:CreateFontString(nil, "OVERLAY")
    SystemStatsFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
...
function MS:UpdateSystemStats()
    ...
    if MS.SystemStatsFrame then
        ...
        MS:ApplyDetachedMinimapLayout(MS.SystemStatsFrame, DB.Layout)
        MS.SystemStatsFrame:SetFrameStrata(GeneralDB.FrameStrata)
        MS.SystemStatsFrame.Text:SetFont(MS.ResolveFont(GeneralDB.Font), DB.Layout[5], GeneralDB.FontFlag)
