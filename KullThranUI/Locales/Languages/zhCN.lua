...
L["Language"] = "语言"
L["This guided setup will help you choose language, fonts, visual style, and recommended addons."] = "此引导设置将帮助您选择语言，字体，视觉样式和推荐的插件。"
L["Choose the language for KullThranUI.\nChanging it will reload the UI and reopen the installer on this step."] = "选择KullThranUI的语言。\n更改它将重新加载UI并在此步骤重新打开安装程序。"
