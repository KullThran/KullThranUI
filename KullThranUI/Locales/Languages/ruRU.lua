...
L["Language"] = "Язык"
L["This guided setup will help you choose language, fonts, visual style, and recommended addons."] = "Эта пошаговая настройка поможет вам выбрать язык, шрифты, визуальный стиль и рекомендуемые аддоны."
L["Choose the language for KullThranUI.\nChanging it will reload the UI and reopen the installer on this step."] = "Выберите язык для KullThranUI.\nЕго изменение перезагрузит пользовательский интерфейс и снова откроет установщик на этом шаге."
