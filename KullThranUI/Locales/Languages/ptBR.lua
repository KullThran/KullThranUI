...
L["Language"] = "Idioma"
L["This guided setup will help you choose language, fonts, visual style, and recommended addons."] = "Esta configuração guiada ajudará você a escolher idioma, fontes, estilo visual e addons recomendados."
L["Choose the language for KullThranUI.\nChanging it will reload the UI and reopen the installer on this step."] = "Escolha o idioma para KullThranUI.\nMudá-lo irá recarregar a interface e reabrir o instalador neste passo."
