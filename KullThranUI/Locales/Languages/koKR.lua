...
L["Language"] = "언어"
L["This guided setup will help you choose language, fonts, visual style, and recommended addons."] = "이 가이드 설정은 언어, 글꼴, 시각적 스타일 및 권장 애드온을 선택하는 데 도움이 됩니다."
L["Choose the language for KullThranUI.\nChanging it will reload the UI and reopen the installer on this step."] = "KullThranUI의 언어를 선택하십시오.\n변경하면 UI가 다시 로드되고 이 단계에서 설치 관리자가 다시 열립니다."
