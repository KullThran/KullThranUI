...
L["Language"] = "Lingua"
L["This guided setup will help you choose language, fonts, visual style, and recommended addons."] = "Questa configurazione guidata ti aiuterà a scegliere la lingua, i caratteri, lo stile visivo e gli addon consigliati."
L["Choose the language for KullThranUI.\nChanging it will reload the UI and reopen the installer on this step."] = "Scegli la lingua per KullThranUI.\nModificandola si ricaricherà l'interfaccia utente e si riaprirà il programma di installazione in questo passaggio."
