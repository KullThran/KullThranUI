-- Arena diminishing-returns data for KullThranUI.
-- Spell categorization derived from DRList-1.0 v1.7.0 (minor 82), MIT licensed:
-- https://github.com/wardz/DRList-1.0
_G.KUI_ARENA_DR_DATA = {
    version = 82,
    resetTime = 16.5,
    categoryOrder = { 'stun', 'incapacitate', 'disorient', 'silence', 'root', 'disarm', 'knockback' },
    categories = {
        stun = { icon = 135963, label = 'STUN', color = { 1.00, 0.22, 0.18 } },
        incapacitate = { icon = 136071, label = 'INCAP', color = { 1.00, 0.82, 0.18 } },
        disorient = { icon = 136184, label = 'FEAR', color = { 0.72, 0.34, 1.00 } },
        silence = { icon = 136164, label = 'SILENCE', color = { 0.35, 0.70, 1.00 } },
        root = { icon = 136100, label = 'ROOT', color = { 0.25, 0.92, 0.42 } },
        disarm = { icon = 132343, label = 'DISARM', color = { 1.00, 0.48, 0.12 } },
        knockback = { icon = 132154, label = 'KNOCK', color = { 0.25, 0.82, 0.90 }, resetTime = 10.5, immediateImmune = true },
    },
    spells = {
        -- *** Disorient Effects ***
